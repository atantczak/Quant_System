...
def ma_sig_gen(tickers, input_list):
    ...
    for ticker in tickers:
        ...
        double_deriv = []
        for i, element in enumerate(data['MA Double Derivative']):
            if element > 0 and data['MA Double Derivative'][i - 1] < 0:
                double_deriv.append(1)
            elif element < 0 and data['MA Double Derivative'][i-1] > 0:
                double_deriv.append(-1)
            else:
                double_deriv.append(0)

        data['Signal'] = double_deriv
