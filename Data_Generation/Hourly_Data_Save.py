    ...
    def new_upload(self, tickers):
        ...
        while end_date is False:
            ...
            for ticker in tickers:
                try:
                    data = api.polygon.historic_agg_v2(str(ticker), 1, timespan='hour', _from=s_today,
                                                       to=s_today).df
                except:
                    continue
                ...
                filename = 'Hourly_SP500_Price_Data/{}_{}.pk'.format(ticker, s_today)
...
ds = Data_Save('2017-01-15', '2021-02-23')
